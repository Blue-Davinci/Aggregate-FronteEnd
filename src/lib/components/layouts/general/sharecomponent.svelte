...
<div class="mb-3 flex space-x-4">
	<Tooltip.Root>
		<Tooltip.Trigger>
			<a
				href={generateTwitterShareUrl(channelTitle, window.location.href)}
				target="_blank"
	...
	<Tooltip.Root>
		<Tooltip.Trigger>
			<a
				href={generateFacebookShareUrl(window.location.href)}
				target="_blank"
	...
	<Tooltip.Root>
		<Tooltip.Trigger>
			<a
				href={generatePinterestShareUrl(window.location.href, imgURL ?? '', channelTitle)}
				target="_blank"
