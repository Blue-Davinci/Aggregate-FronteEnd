	  ...
	  {#if searchQuery}
		<div class="flex flex-col items-center justify-center text-center mt-8">
		  ...
		  <p class="text-xl text-gray-700 dark:text-gray-300">
			...
			<a href="#feeds" on:click|preventDefault={handleResetSearch} class="text-blue-500 hover:underline">
	  ...
	  {:else}
		<div class="flex flex-col items-center justify-center text-center mt-8">
		  ...
		  <div class="flex mt-4 space-x-4">
			<a href="/signup" class="bg-green-500 text-white py-2 px-4 rounded-lg transition-transform transform hover:scale-105 hover:shadow-lg dark:bg-green-600 dark:hover:bg-green-700">
			  Sign Up
			</a>
			<a href="/login" class="bg-yellow-500 text-white py-2 px-4 rounded-lg transition-transform transform hover:scale-105 hover:shadow-lg dark:bg-yellow-600 dark:hover:bg-yellow-700">
			  Log In
			</a>
			<a href="/dashboard" class="bg-blue-500 text-white py-2 px-4 rounded-lg transition-transform transform hover:scale-105 hover:shadow-lg dark:bg-blue-600 dark:hover:bg-blue-700">
			  Go to Dashboard
			</a>
		  </div>
		  <p class="mt-4 text-sm text-gray-600 dark:text-gray-400">
